...
export default function DoctorLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('doctorName', email);
      localStorage.setItem('doctorSpecialty', 'Терапевт');
      setIsLoading(false);
      router.push('/doctor/dashboard');
    }, 1000);
  };

  // Demo doctor account auto-fill
  const fillDemoAccount = () => {
    setEmail('dr.ivanov@clinic.com');
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="text-center transform transition-all duration-1000 ease-out">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Вход для врачей</h2>
          <p className="text-gray-600">Войдите в медицинскую систему</p>
        </div>
